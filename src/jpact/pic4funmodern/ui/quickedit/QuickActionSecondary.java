package jpact.pic4funmodern.ui.quickedit;
 ...
 */
public class QuickActionSecondary extends PopupWindows implements OnDismissListener {
	 ...
	 */
	public QuickActionSecondary(Context context) {
		super(context);
		...
		setRootViewId(R.layout.quickactionsecondary);
	...
	public void setRootViewId(int id) {
		...
		//when tapping fastly on a view to show QuickActionSecondary dialog.
		...
		container.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				if (mItemClickListener != null) {
                    mItemClickListener.onItemClick(QuickActionSecondary.this, pos, actionId);
                }
	 ...
	 */
	public void setOnDismissListener(QuickActionSecondary.OnDismissListener listener) {
	...
	public interface OnActionItemClickListener {
		public abstract void onItemClick(QuickActionSecondary source, int pos, int actionId);
	}
